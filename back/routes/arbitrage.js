...
const { getPresences, getMesPresences, getMatchsBesoinArbitre, addPresence, deletePresence, getStats } = require('../controllers/arbitrageController');

router.use(authenticate);

router.get('/matchs-besoin-arbitre', requireMinRole('joueur'), getMatchsBesoinArbitre);
