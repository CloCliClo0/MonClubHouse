...
const { getAll, getById, create, update, remove, addCoach, updateCoachs, getCategoriesCoach } = require('../controllers/equipeController');
...
router.post('/:id/coachs/add', authenticate, requireMinRole('dirigeant'), addCoach);
