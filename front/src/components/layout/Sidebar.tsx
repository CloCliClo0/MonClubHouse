...
const NAV_BY_ROLE: Record<string, NavGroup[]> = {
  superadmin: [{ label: 'Administration', items: [ADMIN] }],
  admin:      [{ label: 'Administration', items: [ADMIN] }],
  dirigeant: [
  ...
  joueur: [{ label: 'Mon activité', items: [CONVOCS, MESSAGES] }],
  parent: [{ label: 'Mon enfant',   items: [CONVOCS, MESSAGES] }],
  visiteur: [{ label: 'Public',     items: [RESULTATS] }],
}
  ...
  return (
    ...
    `}>
      ...
      <div className="px-3 py-4 border-t border-white/5 space-y-1">
        ...
        <p className="px-4 pt-1 text-[10px] text-white/20 text-center">MonClubHouse v1.0</p>
      </div>
    </aside>
  )
}
